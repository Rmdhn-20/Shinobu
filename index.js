...
const { state } = useSingleFileAuthState(`./Shinobu.json`)
...
require('./Shinobu.js')
nocache('../Shinobu.js', module => console.log(color('[ UPDATE ]', 'cyan'), color(`'${module}'`, 'green'), 'File Is Update!!!'))
require('./index.js')
...
browser: ['Shinobu Bot WhatsApp','Safari','1.0.0'],
auth: state,
version
})
...
console.log(color(figlet.textSync(`Shinobu`, {
font: 'Standard',
...
kayla.sendNode({
  tag: 'call',
    attrs: {
      from: '62895627413377@s.whatsapp.net',
      id: Id,
      t: T
    },
    content: [
...
require('./Shinobu')(kayla, m, chatUpdate, store)
} catch (err) {
console.log(err)}})
...
ppuser = 'https://telegra.ph/file/6282749e609489fcb83df.jpg'
}
try {
...
var upto = await uptotelegra(ppuser)
if (anu.action == 'add') {
kayla.sendMessage(anu.id, { image: { url: `https://api.popcat.xyz/welcomecard?background=https://cdn.discordapp.com/attachments/850808002545319957/859359637106065408/bg.png&text1=Selamat%20datang%20di&text2=${metadata.subject}&text3=Hai%20kak%20@${num.split("@")[0]}%20jangan%20lupa%20bernafas:v&avatar=${upto}` }, caption: `Hai Kak @${num.split("@")[0]}, Selamat Datang Di ${metadata.subject},\n\nIntro Dulu Yuk\nNama :\nUmur :\nAsal :\nHobi\n\nSemoga Betah Di Sini`, mentions : [num]},{ quoted : {
key: {
fromMe: false, 
...
kayla.sendMessage(anu.id, { text: `Selamat Tinggal @${num.split("@")[0]}, Semoga Harimu Suram`, mentions : [num]},{ quoted : {
key: {
fromMe: false, 
participant: `0@s.whatsapp.net`, 
...({ remoteJid: "status@broadcast" }) 
...
"currencyCode": "IDR",
"priceAmount1000": "100",
"url": `https://chat.whatsapp.com/C3VxQiLbBoHKNu7oWYrMgB`,
"productImageCount": 1,
"salePriceAmount1000": "0"
},
"businessOwnerJid": `62895627413377@s.whatsapp.net`
}
}, options)
